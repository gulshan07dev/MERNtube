...
export default function Button({
  ...
  return (
    <button
      className={twMerge(
        btnType == "simple-btn"
          ? "rounded-[4px] flex gap-2 items-center justify-center border bg-[#ff1cf4] hover:opacity-60 transition-[background] text-white font-medium font-Noto_sans disabled:opacity-60"
