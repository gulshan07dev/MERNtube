...
export default function SearchBar() {
  return (
    <div className="md:w-[550px] w-[300px] transition-all group border border-gray-300 rounded-full bg-[#f8f8f8] relative overflow-hidden flex justify-between items-center">
